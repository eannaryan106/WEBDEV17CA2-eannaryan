package com.eannaRyan.Music_Pro;
...
public class App {
	...
	private static void actionCommandlineInput(String args[]) {
		...
		try {
			...
			optionParser.acceptsAll(Arrays.asList("d", "database"), "Path	and	name	of	database	file.").withRequiredArg().ofType(String.class).describedAs("SQlite	database");
			...
			if (options.has("version")) {
				System.out.println("Music_Pro version:" + VERSION);
				System.exit(0);
			}
