 ...
 *
 *         Ref:
 *         https://github.com/bethrobson/Head-First-Design-Patterns/tree/master/src/headfirst/designpatte
 *         rns/composite/menu
 * 
 *****************************************************************/
	...
	private	void	buildMenu()
	 {
	 	 ...
	 	 playHeading.add(	new	MenuItem(	
	 	 	 	 ...
	 	 	 	 "com.oreallyoreilly.pythia.playlist.PlaylistViewMenuItem"
	 	 	 	 ));
	 	 playHeading.add(	new	MenuItem(	
	 	 	 	 2,
	 	 	 	 "List	Music",
	 	 	 	 "List	the	music	available	in	the	system",
	 	 	 	 "com.oreallyoreilly.pythia.music.MusicViewMenuItem"
	 	 	 	 ));
	 	 ...
	 	 playHeading.add(	new	MenuItem(	
	 	 	 	 ...
	 	 	 	 "com.oreallyoreilly.pythia.user.UserViewMenuItem"
	 	 	 	 ));	
